...
import { changeVoiceVolumeAction, voiceVolumeAtom } from "@/features/settings/state";
...
export function Volume() {
  ...
  const changeVoiceVolume = useAtomSet(changeVoiceVolumeAction);

  return (
    <Slider.Root className="my-3 w-full" thumbAlignment="edge" min={0} max={1} step={0.1} value={voiceVolume} onValueChange={changeVoiceVolume}>
