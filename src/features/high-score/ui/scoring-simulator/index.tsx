    ...
    <article className="mx-auto grid max-w-4xl gap-6 bg-surface-2 p-3">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <section className="grid place-items-center bg-surface-1 p-3">
          <h4 className="font-sans text-sm font-semibold tracking-widest text-text-2 uppercase">Turn Guessed</h4>
        ...
        <section className="grid place-items-center bg-surface-1 p-3">
          <h4 className="font-sans text-sm font-semibold tracking-widest text-text-2 uppercase">Time Elapsed</h4>
          ...
          <h4 className="font-sans text-sm font-semibold tracking-widest text-text-2 uppercase">Speed Multiplier</h4>
